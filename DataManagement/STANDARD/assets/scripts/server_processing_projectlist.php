...
// DB table to use
$table = "userpro_auth
            left join project_budget on project_budget.idproject_budget = userpro_auth.project_budget_idproject_budget
            left join login_user on login_user.idlogin_user = userpro_auth.login_user_idlogin_user
...
$columns = array(
    ...
    array('as' => 'as6', 'tb' => 'project_budget', 'db' => 'approval', 'dt' => 4),
