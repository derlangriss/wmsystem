var app = angular.module('app', ['rdsystem']);
...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: "WMSystem | Admin Web App",
        author: "QSBG",
        description: "Warehouse Management System",
        version: '1.0', // current version
        year: ((new Date()).getFullYear()), // automatic current year (for copyright information),
        fiscalyear:(function () {// true if the browser is a mobile device
            var fiscalyear = '';
            var today = new Date();
            ...
            var d2 = new Date(yyyy,9,30)

            if(d1 > d2){
                fiscalyear = yyyy+1
            } else fiscalyear = yyyy
        ...
        defaultLayout: {
            ...
            theme: 'lyt2-theme-3', // indicate the theme chosen for your project
            logo: 'assets/images/logo-inner.png', // relative path of the project logo
            logoCollapsed: 'assets/images/logo-collapse.png' // relative path of the collapsed logo
        },
        layout: ''
    };
