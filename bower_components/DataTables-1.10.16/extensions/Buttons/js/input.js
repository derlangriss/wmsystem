...
(function ($) {
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			nInput.type = 'input';
			nPage.innerHTML = '<span class="label label-default margin-navi">page</span>';
		...
		'fnUpdate': function (oSettings) {
			...
			$(an).children('.' + firstClassName)
				...
				.addClass('btn btn-transparent btn-xs tooltips');
			...
			$(an).children('.' + paginateOfClassName).html(' of ' + iPages)
			    .addClass('label label-default margin-navi');


			// Current page numer input value
			$(an).children('.' + paginateInputClassName).val(iCurrentPage);
			$(an).children('.' + paginateInputClassName)
			.addClass('btn btn-transparent btn-xs tooltips form-navi');
		}
	};
})(jQuery);