...
if ($host=="buprestis")
    ...
    $smarty->template_dir = '/var/www/databases/qsbgcoll/smarty/templates';
    $smarty->compile_dir = '/var/www/databases/qsbgcoll/smarty/templates_c';
    $smarty->cache_dir = '/var/www/databases/qsbgcoll/smarty/cache';
    $smarty->config_dir = '/var/www/databases/qsbgcoll/smarty/configs';
}
else
    {
  ...
  {
    require('c:/Apache24/smarty/libs/Smarty.class.php');
    //require 'Smarty.class.php';

    $smarty = new Smarty;

    $smarty->template_dir = 'c:/Apache24/htdocs/qsbgcolldb/application/qavd2/smarty/templates';
    $smarty->compile_dir = 'c:/Apache24/smarty/templates_c';
    $smarty->cache_dir = 'c:/Apache24/smarty/cache';
    $smarty->config_dir = 'c:/Apache24/htdocs/qsbgcolldb/application/qavd2/smarty/configs';
  }
