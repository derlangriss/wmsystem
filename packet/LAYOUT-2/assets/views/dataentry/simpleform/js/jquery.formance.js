...
(function() {
  ...
  restrictNumericdecimal = function(e) {
    var $target, input;
  ...
  $.formance.fn.restrictNumeric = function() {
   ...
   $.formance.fn.restrictNumericdecimal = function() {
    this.on('keypress', restrictNumericdecimal);
    return this;
  };
  ...
  formatDateDDMMYYYY = function(e) {
    ...
    if (/^\d$/.test(val) && (digit !== '0' && digit !== '1' && digit !== '2' && digit !== '3')) {
      ...
      e.preventDefault();
      return $target.val("" + val + "-");
    } else if (/^\d{2}\-\d$/.test(val) && (digit !== '0' && digit !== '1')) {
      e.preventDefault();
  ...
  formatForwardDateDDMMYYYY = function(e) {
    ...
    $target = $(e.currentTarget);
    val = $target.val();
    if (/^\d{2}$/.test(val) || /^\d{2}\-\d{2}$/.test(val)) {
      return $target.val("" + val + "-");
    }
  };
  ...
  $.formance.fn.format_numberdecimal = function() {
    var length;
    ...
    this.formance('restrictNumericdecimal');
    return this;
  };

  $.formance.fn.validate_numberdecimal = function() {
    var $this, length, val;
  ...
  formatOntarioDriversLicenseNumber = function(e) {
    ...
    } else if (/^[A-Za-z]{0,4}$/.test(old_val)) {
      e.preventDefault();
      if (/^[A-Za-z]{4}$/.test(val)) {
        val = "" + val + "-";
      }
      if (/^[A-Za-z]{0,4}[\s|\-]*$/.test(val)) {
        return $target.val(val);
      }
    } else if (/^[A-Za-z]{4}[\s|\-]*\d{0,4}$/.test(old_val)) {
      e.preventDefault();
      if (/^[A-Za-z]{4}[\s|\-]*\d{4}$/.test(val)) {
        val = "" + val + "-";
      }
      if (/^[A-Za-z]{4}[\s|\-]*\d{0,4}[\s|\-]*$/.test(val)) {
        return $target.val(val);
      }
    } else if (/^[A-Za-z]{4}[\s|\-]*\d{0,4}[\s|\-]*$/.test(old_val)){
       e.preventDefault();
      if (/^[A-Za-z]{4}[\s|\-]*\d{0,4}[\s|\-]*\d{0,4}$/.test(val)) {
        return $target.val(val);
      }
  ...
  $.formance.fn.format_collection_number = function() {
  ...
  $.formance.fn.validate_collection_number = function() {
    var regex, val;
  ...
  formatDateYYYYMMDD = function(e) {
    ...
    if (/^\d{4}$/.test(val)) {
      e.preventDefault();
      return $target.val("" + val + "-");
    } else if (/^\d{4}\-\d$/.test(val) && (digit !== '0' && digit !== '1')) {
      e.preventDefault();
      return $target.val("" + old_val + "0" + digit + "-");
    } else if (/^\d{4}\-\d{2}$/.test(val)) {
      e.preventDefault();
      return $target.val("" + val + "-");
    } else if (/^\d{4}\-\d{2}\-\d$/.test(val) && (digit !== '0' && digit !== '1' && digit !== '2' && digit !== '3')) {
      e.preventDefault();
      return $target.val("" + old_val + "0" + digit);
    }
  };
  ...
  formatForwardDateYYYYMMDD = function(e) {
    ...
    $target = $(e.currentTarget);
    val = $target.val();
    if (/^\d{4}$/.test(val) || /^\d{4}\-\d{2}$/.test(val)) {
      return $target.val("" + val + "-");
    }
  };
