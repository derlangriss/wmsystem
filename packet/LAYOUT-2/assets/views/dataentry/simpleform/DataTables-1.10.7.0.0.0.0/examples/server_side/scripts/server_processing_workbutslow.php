...
// DB table to use
$table = "harvest
left join state on harvest.stateid=state.stateid
left join parks on harvest.parkid=parks.parkid";
...
$columns = array(
	...
	array( 'as'=>'as3','tb'=>'parks','db' => 'name',   'dt' => 2 ),
	array( 'as'=>'as4','tb'=>'harvest','db' => 'locale',     'dt' => 3 ),
	array( 'as'=>'as5','tb'=>'state','db' => 'name',     'dt' => 4 ),
...
require( 'ssp.class.workbutslow.php' );
