...
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
  ...
  function autocollnumber() {
    ...
    /**variable get from coll_number.php**/
  ...
  function search_number() {
    ...
    $.ajax({
        ...
        data: dataset,
        success: function(result) {
            $("#txtcoll_autonumber_on_inter").html(result);
            autocollnumber();
        }
    });
  }
  ...
  $(document).ready(function(){
    ...
    colectionmethodlist();
    collectorlist();
    $('input#txtcoll_number_inter').on('keyup', function(e) {
    if (e.which == 13) {
        $.ajax({ 
        ...
        <div class="gf-row-6 ">
            <div class="gf-col-2 gf-col-bg">
                ...
                <label class="text-inline input_tiny"><INPUT class='number ' onkeyup="search_number(); " name=
                            "txtcoll_year_inter" id="txtcoll_year_inter" type="text" value="{{data.coll_year}}" autofocus></label>
                <label class="text-inline input_tiny"><INPUT class='number ' name="txtcoll_number_inter" id=
                            "txtcoll_number_inter" type="text" value="{{data.coll_number}}" autofocus></label>
                              <label class="text-inline input_tiny"><button id="collection_search" class="btn01 btn-primary" type="button">Go!</button></label>                           
                           <INPUT name="txtidcollection" id="txtidcollection" type="hidden" value="{{data.idcollection}}" autofocus>
                            <INPUT name="txtcollection_ID" id="txtcollection_ID" type="hidden" autofocus>
                           </div>
                                ...
                                <div class="gf-row-6 gf-large">
                                    <div class="gf-col-2">
                                        ...
                                        <INPUT class='numberdecimal' placeholder="Only Digits" onkeyup=
                                              ...
                                              id="txtlatdec" name="txtlatdec" value="{{data.collectionlatdec}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>LatH</label>
                                    ...
                                    <div class="gf-col-2">
                                        ...
                                        <INPUT class='numberdecimal' placeholder="Only Digits" onkeyup=
                                              "JavaScript:doCallAjaxautofill('txtlatdec','txtlongdec','txtprovinceen','txtamphur_ID','txtamphuren','txttambon');" type="text"
                                              id="txtlongdec" name="txtlongdec" value="{{data.collectionlongdec}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>LongH</label>
                                ...
                                <div class="gf-row-6 gf-large">
                                    <div class="gf-col-1">
                                        ...
                                        <INPUT onkeyup="getmarkerDMS('txtlatdec','txtlongdec','txtprovinceen','txtamphur_ID','txtamphuren','txttambon');"
                                              class="input_tiny" name="txtlat_d" id="txtlat_d" type="text" value="{{data.collectionlatd}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>Lat M</label>
                                        <INPUT class='number input_tiny' onkeyup=
                                              ...
                                              "txtlat_m" type="text" value="{{data.collectionlatm}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>Lat S</label>
                                        <INPUT class='numberdecimal input_tiny' onkeyup=
                                              ...
                                              "txtlat_s" type="text" value="{{data.collectionlats}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>Long D</label>
                                        <INPUT class='number input_tiny validate[custom[integer],max[180]]' onkeyup=
                                          ...
                                          "txtlong_d" type="text" value="{{data.collectionlongd}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>Long M</label>
                                        <INPUT class='number input_tiny' onkeyup=
                                              "getmarkerDMS('txtlatdec','txtlongdec','txtprovinceen','txtamphur_ID','txtamphuren','txttambon');" name="txtlong_m" id=
                                              "txtlong_m" type="text" value="{{data.collectionlongm}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>Long S</label>
                                        <INPUT class='numberdecimal input_tiny' onkeyup=
                                              "getmarkerDMS('txtlatdec','txtlongdec','txtprovinceen','txtamphur_ID','txtamphuren','txttambon');" name="txtlong_s" id=
                                              "txtlong_s" type="text" value="{{data.collectionlongs}}" autofocus>
                                    </div>
                                </div>
                                <div class="gf-row-2 gf-large">
                                    <div class="gf-col-1">
                                        <label>northing</label>
                                        <INPUT type="text" id="txtNorthing" name="txtNorthing" class="input_small" value="{{data.collectionnorthing}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>easting</label>
                                        <INPUT type="text" id="txtEasting" name="txtEasting" class="input_small" value="{{data.collectioneasting}}" autofocus>
                                    </div>
                                </div>    
                                <div class="gf-row-2 gf-large">    
                                    <div class="gf-col-1">
                                        <label>UTM</label>
                                        <INPUT name="txtUTM" id="txtUTM" type="text" value="{{data.collectionutm}}" autofocus>
                                    </div>
                                    <div class="gf-col-1">
                                        <label>MASL</label>
                                        <INPUT class='numberdecimal validate[custom[integer],max[2800]] text-input' name="txtMASL" id="txtMASL" type="text"
                                        value="{{data.collectionmasl}}" autofocus>
                                    </div>
                                </div>
                ...
                <fieldset>
                    <legend>Location Administrative</legend>
                       ...
                       <div class="gf-col-1">
                           ...
                           <INPUT class="disabletextbox" readonly type="text" id="txtprovinceen" name="txtprovinceen" value="{{data.provinceen}}" autofocus>
                       </div>
                       <div class="gf-col-1">
                           <label>Amphur English (thai)</label>
                           <INPUT readonly class="disabletextbox" type="text" id="txtamphuren" name="txtamphuren" value="{{data.amphuren}}" autofocus>
                       </div>
                       <div class="gf-col-1">
                           <label>tambon English (thai)</label>
                           <INPUT readonly type="text" id="txttambon" name="txttambon" class="disabletextbox" value="{{data.tambonen}}" autofocus>
                       </div>
                   </div>
                   <div class="gf-row-2 gf-large">
                       <div class="gf-col-1">
                       ...
                       <div class="gf-col-1">
                           ...
                           <INPUT type="text" name="txtspecific_locality" id="txtspecific_locality" value="{{data.collectionspecificlocality}}" autofocus>
                       </div>
    ...
    <INPUT type="hidden" id="txtcoll_autonumber_on_inter" name="autonumber_inter">
