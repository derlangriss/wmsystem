...
{ 
  ...
  function initialize() {
   ...
   function doCallAjaxinterface(Mode) {
    ...
    $.ajax({ 
        type: "POST",
        url: "views/dataentry/simpleform/dbinsertspecimen.php",
        data: pmeters,      
  ...
  $(document).ready(function(){
    ...
    <fieldset>
       <legend>Specimen Data Entry</legend>
        <div class="gf-row-6 ">
            <div class="gf-col-2 gf-col-bg">
                  
      
                 <fieldset>
                    <legend>Specimen Number</legend>
                ...
                <label class="text-inline input_tiny"><INPUT class='number ' name="txtcoll_number_inter" id=
                            "txtcoll_number_inter" type="text" autofocus></label>-
