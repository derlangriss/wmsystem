...
<HEAD>
  ...
  $(document).ready(function(){
  $("body").ready(function(){doCallAjaxinterface('LIST'),colectionmethodlist(),collectorlist();});
                    ...
                    <legend>Collection Number</legend>
                          <div class="gf-row-2 gf-large">
                           <div class="gf-col-2">
                               ...
                               <label class="text-inline input_tiny"><INPUT class='number ' name="txtcoll_code_inter" id=
     ...
     <fieldset>
        ...
        <div class="gf-row-2 gf-large">
            ...
            <div class="gf-col-1">
                ...
                <SELECT class="validate[required]" name="txtcollection_method_ID" id="txtcollection_method_ID" autofocus>
                </SELECT>

            </div>
            <div class="gf-col-1">
                <label>Collector</label>
                <SELECT class="validate[required]" name="txtcollector_ID" id="txtcollector_ID" autofocus>
                </SELECT>
            </div>
        </div>
    </fieldset>
      ...
      "Similar collection" autofocus> &nbsp; <INPUT type="reset" value="Done-leave interface" autofocus>
    </fieldset>    
            </div>
