...
left join province on amphurs.province_idprovince=province.idprovince WHERE TRUE AND coll_code  = '".$_POST["sCode"]."' AND coll_year  = '".$_POST["sYear"]."' AND coll_number  = '".$_POST["sNumber"]."' ";
