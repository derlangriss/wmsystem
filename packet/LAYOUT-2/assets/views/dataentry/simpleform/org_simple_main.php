...
<HEAD>
  ...
  <LINK rel="stylesheet" href="collection_assets/css/simpleform.css" type="text/css">
  ...
  <SCRIPT src="collection_assets/js/jquery.formalize.js" type="text/javascript">
</SCRIPT>
  <SCRIPT src="collection_assets/js/jquery.maskedinput.js" type="text/javascript">
</SCRIPT>
  <SCRIPT src="js/jquery.formance.js" type="text/javascript">
</SCRIPT>
  <SCRIPT src="js/awesome_form.js" type="text/javascript">
</SCRIPT>
  ...
  function insertcollection_method() {
    ...
    $.ajax({
        type: 'POST',
        url: 'insert_collection_method.php',
        data: datastring,
