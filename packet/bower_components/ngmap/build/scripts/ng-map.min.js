angular.module("ngMap", []),
    ...
    function() {
        ...
        var e, t, n, o = [],
            ...
            p = function(r, i, p) {
                return t = r[0], e = i, n = p, {
                    mapInstances: o,
                    getMapInstance: a,
                    returnMapInstance: s
                }
            };
        p.$inject = ["$document", "$window", "$timeout"], angular.module("ngMap").factory("NgMapPool", p)
    }(),
    function() {
        "use strict";
        var e, t, n, o, r, i, a, s = {},
            ...
            g = function(e) {
                var t = Object.keys(s).length - 1,
                    n = e.map.id || t;
                if (e.map) {
                    for (var o in e.mapEvents) google.maps.event.clearListeners(e.map, o);
            ...
            m = function(e) {
                ...
                "true" == t ? (e.style.display = "block", e.style.height = "300px") : ("block" != p(e, "display") && (e.style.display = "block"), p(e, "height").match(/^(0|auto)/) && (e.style.height = "500px"))
            };
